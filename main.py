...
def main(args):
    ...
    if not args.test_only:
        ...
        # Start training
        try:trainer(train_loader, val_loader, val_metric_loader, test_loader, 
        ...
        # Print the CUDA out-of-memory error message
            print(f"Error: {e}")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--SoccerNet_path',   required=True, type=str,default='C:/Users/savin/Documents/Dataset/', help='Path to the SoccerNet-V2 dataset folder' )
